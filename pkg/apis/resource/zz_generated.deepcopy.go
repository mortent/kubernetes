...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SpecificDeviceRequest) DeepCopyInto(out *SpecificDeviceRequest) {
	*out = *in
	if in.Selectors != nil {
		in, out := &in.Selectors, &out.Selectors
		*out = make([]DeviceSelector, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SpecificDeviceRequest.
func (in *SpecificDeviceRequest) DeepCopy() *SpecificDeviceRequest {
	if in == nil {
		return nil
	}
	out := new(SpecificDeviceRequest)
