...
func SetDefaults_DeviceRequest(obj *resourceapi.DeviceRequest) {
	...
	if obj.Exactly != nil {
		if obj.Exactly.AllocationMode == "" {
			obj.Exactly.AllocationMode = resourceapi.DeviceAllocationModeExactCount
		}

		if obj.Exactly.AllocationMode == resourceapi.DeviceAllocationModeExactCount && obj.Exactly.Count == 0 {
			obj.Exactly.Count = 1
		}
	}
}
