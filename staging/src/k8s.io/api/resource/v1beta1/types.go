...
// of alternative subrequests using the firstAvailable list.
//
// A DeviceClassName is currently required if the firstAvailable list is
...
// handle the request.
// If the firstAvailable list has one or more subrequests, then
...
type DeviceRequest struct {
	...
	// firstAvailable slice. Which classes are available depends on the cluster.
	//
