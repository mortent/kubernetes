  ...
  map:
    ...
    - name: expression
      type:
        scalar: string
      default: ""
- name: io.k8s.api.resource.v1beta2.CompositeDevice
  map:
    fields:
    - name: attributes
      type:
    ...
    - name: consumesCapacityFrom
      type:
        list:
          elementType:
            namedType: io.k8s.api.resource.v1beta2.DeviceRef
          elementRelationship: atomic
    - name: includes
      type:
        list:
          ...
          elementRelationship: atomic
- name: io.k8s.api.resource.v1beta2.CompositeDeviceMixin
  map:
    fields:
    - name: attributes
      type:
...
- name: io.k8s.api.resource.v1beta2.Device
  map:
    ...
    - name: composite
      type:
        namedType: io.k8s.api.resource.v1beta2.CompositeDevice
    - name: name
      type:
        scalar: string
      default: ""
...
- name: io.k8s.api.resource.v1beta2.DeviceMixin
  map:
    ...
    - name: composite
      type:
        namedType: io.k8s.api.resource.v1beta2.CompositeDeviceMixin
    - name: name
      type:
        scalar: string
      default: ""
  ...
  map:
    ...
    - name: name
      type:
        scalar: string
      default: ""
- name: io.k8s.api.resource.v1beta2.DeviceRef
  map:
    fields:
    - name: name
      type:
